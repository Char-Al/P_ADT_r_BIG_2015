...
def detectLanguagesMails(repertory, out):
	file_FRA = open("/home/char-al/Documents/ADT/projet/P_ADT_r_BIG_2015/Project_Final/learning/FRA.txt","r")
	learning_FRA = ""
	...
	file_ENG = open("/home/char-al/Documents/ADT/projet/P_ADT_r_BIG_2015/Project_Final/learning/ENG.txt","r")
	learning_ENG = ""
	...
	for mails in glob.glob("*"):
		...
		e = Email(mails)
		GLOBAL_F.write(name.group(1) + "\t" + detector.detect(e.get_body(),1,False)[0][0] + "\n")
		FILE.write("Le mail \"" + name.group(1) + "\" est globalement en : " + detector.detect(e.get_body(),1,False)[0][0] + "\n")
		FILE.write(str(detector.detect(e.get_subject(),1,False)) + "\n")
		FILE.write("Language by Stop Words : " + SW_detect.stopWords_detect(e.get_body()) + "\n")
		FILE.write("\n\n+++++++++++++++++++++++++++++++++++++++++++++++++\n+++++++++++++++++++++++++++++++++++++++++++++++++\n")
		FILE.write("Le sujet du mail est en : " + detector.detect(e.get_subject(),1,False)[0][0] + "\n")
		FILE.write("Subject : " + e.get_subject() + "\n")
		i=0
		FILE.write("\n\n+++++++++++++++++++++++++++++++++++++++++++++++++\n+++++++++++++++++++++++++++++++++++++++++++++++++\n")
		for paragraph in cuttingText.getSubsections(e.get_body()):
			i+=1
			FILE.write("Le paragraphe " + str(i) + " est en : " + detector.detect(paragraph, 1, False)[0][0] + "\n\t" + paragraph + "\n\n==========================================\n")
		i=0
		FILE.write("\n\n+++++++++++++++++++++++++++++++++++++++++++++++++\n+++++++++++++++++++++++++++++++++++++++++++++++++\n")
		for sentence in cuttingText.getSentences(e.get_body()):
			i+=1
			FILE.write("La phrase " + str(i) + " est en : " + detector.detect(sentence, 1, False)[0][0] + "\n\t" + sentence + "\n==========================================\n")
		FILE.close()
